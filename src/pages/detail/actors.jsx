...
const Actors = ({ cast }) => {
    ...
    const getPicture = (actor) => {
        return actor.profile_path ? baseImgUrl + actor.profile_path :
            actor.gender === 1 ? "/woman.jpg" :
                actor.gender === 2 ? "/man.jpg" :
                    "/default.webp"
    }
    ...
    return isRender ? (
        ...
        <div className='mb-10 text-center text-zinc-400'>Oyuncu Bilgisi Bulunamadı</div>
